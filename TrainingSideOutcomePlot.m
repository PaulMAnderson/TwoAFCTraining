...
% Adapted by Paul Anderson 10/2024


function TrainingSideOutcomePlot(AxesHandle, Action, varargin)
...
switch Action
    case 'init'
        ...
        set(AxesHandle,'TickDir', 'out','YLim', [-1, 2], 'YTick', [0 1],'YTickLabel', {'Right','Left'}, 'FontSize', labelFontSize);
